...
public class PageConstants {
    ...
    public static final String SUCCESS_REGISTRATION_PAGE_URL = "/user/successRegister";
    ...
    public static final String EMAIL_ERROR_PAGE_URL = "emailError";
    public static final String BAD_USER_PAGE_URL = "badUser";
    ...
    public static final String QR_CODE_PAGE_URL= "/qrcode";
    ...
    public static final String QR_CODE_LOCATION_TEMPLATE = "qrcode";
    public static final String REGISTRATION_PAGE_LOCATION_TEMPLATE = "user/registration";
    public static final String REGISTRATION_CONFIRM_PAGE_LOCATION_TEMPLATE = "user/registrationConfirm";
    ...
    public static final String UPDATE_PASSWORD_LOCATION_TEMPLATE = "user/updatePassword";
    public static final String PROFILE_PASSWORD_LOCATION_TEMPLATE = "user/profile";
    public static final String EXPIRED_ACCOUNT_PASSWORD_LOCATION_TEMPLATE = "user/expiredAccount";
    public static final String CHANGE_PASSWORD_LOCATION_TEMPLATE = "user/changePassword";
    ...
    public static final String REDIRECT_UPDATE_PASSWORD = "redirect:/user/updatePassword";
